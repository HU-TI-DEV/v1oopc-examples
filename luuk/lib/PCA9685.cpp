...
void PCA9685_i2c::reset() {
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, (uint8_t)pca9685_bits::MODE1_RESTART);
    hwlib::wait_ms(10);
}
...
void PCA9685_i2c::sleep() {
    uint8_t awake = read8((uint8_t) pca9685_registers::PCA9685_MODE1);
    uint8_t sleep = awake | (uint8_t)pca9685_bits::MODE1_SLEEP; // set sleep bit high
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, sleep);
...
void PCA9685_i2c::wakeup() {
    uint8_t sleep = read8((uint8_t) pca9685_registers::PCA9685_MODE1);
    uint8_t wakeup = sleep & ~(uint8_t) pca9685_bits::MODE1_SLEEP; // set sleep bit low
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, wakeup);
}
...
void PCA9685_i2c::setExtClk(uint8_t prescale) {
    uint8_t oldmode = read8((uint8_t) pca9685_registers::PCA9685_MODE1);
    uint8_t newmode = (oldmode & ~(uint8_t) pca9685_bits::MODE1_RESTART) | (uint8_t) pca9685_bits::MODE1_SLEEP; // sleep
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, newmode); // go to sleep, turn off internal oscillator

    // This sets both the SLEEP and EXTCLK bits of the MODE1 register to switch to
    // use the external clock.
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, (newmode |= (uint8_t) pca9685_bits::MODE1_EXTCLK));

    write8((uint8_t) pca9685_registers::PCA9685_PRESCALE, prescale); // set the prescaler

    hwlib::wait_ms(5);
    // clear the SLEEP bit to start
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, (newmode & ~(uint8_t) pca9685_bits::MODE1_SLEEP) | (uint8_t) pca9685_bits::MODE1_RESTART | (uint8_t) pca9685_bits::MODE1_AI);
}
...
void PCA9685_i2c::setPWMFreq(float freq) {
    ...
    uint8_t oldmode = read8((uint8_t) pca9685_registers::PCA9685_MODE1);
    uint8_t newmode = (oldmode & ~(uint8_t) pca9685_bits::MODE1_RESTART) | (uint8_t) pca9685_bits::MODE1_SLEEP; // sleep
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, newmode);                             // go to sleep
    write8((uint8_t) pca9685_registers::PCA9685_PRESCALE, prescale); // set the prescaler
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, oldmode);
    hwlib::wait_ms(5);
    // This sets the MODE1 register to turn on auto increment.
    write8((uint8_t) pca9685_registers::PCA9685_MODE1, oldmode | (uint8_t) pca9685_bits::MODE1_RESTART | (uint8_t) pca9685_bits::MODE1_AI);
...
void PCA9685_i2c::setOutputMode(bool totempole) {
    uint8_t oldmode = read8((uint8_t) pca9685_registers::PCA9685_MODE2);
    uint8_t newmode;
    if (totempole) {
    ...
    write8((uint8_t) pca9685_registers::PCA9685_MODE2, newmode);
}
...
uint8_t PCA9685_i2c::readPrescale(void) {
    return read8((uint8_t) pca9685_registers::PCA9685_PRESCALE);
}
...
uint8_t PCA9685_i2c::getPWM(uint8_t num) {
    return read8( (uint8_t) pca9685_registers::PCA9685_LED0_ON_L + 4 * num );
}
...
uint8_t PCA9685_i2c::read8(uint8_t reg) {
    bus.write( address ).write(reg);
    return bus.read( address ).read_byte();
}

void PCA9685_i2c::write8(uint8_t reg, uint8_t d) {
